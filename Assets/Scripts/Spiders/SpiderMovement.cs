...
public class SpiderMovement : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (valueX != 0 || valueY != 0)
        {
            ...
            Vector3[] pos = GetClosestPoint(transform.position, transform.forward, transform.up, 0.5f, raysEccentricity, innerRaysOffset, outerRaysOffset, raysSpider);
